...
description: Use for WordPress plugin work - creating/refactoring plugin structure, hooks/actions/filters, activation/deactivation/uninstall, settings pages, security fixes (nonces, capabilities, sanitization), and packaging releases.
---
...
- Activation hook not firing: hook registered incorrectly (not in main file scope), wrong main file path, or plugin is network-activated.
